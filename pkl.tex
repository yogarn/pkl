...
% -----------------------------------------------------------------
% title
\titlepkl{Implementasi dan Pengujian Skenario Jaringan Wi-Fi pada APIE Pilot Project di Universitas Brawijaya}
% personal data
\authorone{Yoga Raditya Nala}{235150201111020}
\authortwo{Nizar Maulana Wahyudi}{235150201111052}
\approvaldate{11}
\degree{N/A}
\yearsubmit{2026}
\laboratory{Komputasi Berbasis Jaringan}
\pklplacetype{Direktorat}
\pklstartdate{29 Juni}
\pklenddate{29 Agustus 2026}
\pklplace{Teknologi Informasi Universitas Brawijaya}
...
\selectlanguage{indonesian}\clearpage\pagenumbering{arabic}\setcounter{page}{1}
