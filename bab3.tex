...
Pada arsitektur WLAN berbasis \textit{controller}, fungsi kontrol dan penerusan trafik pengguna dapat dipisahkan. Seperti yang ditunjukkan pada Gambar ~\ref{fig:ruckus_smartzone_architecture}, RUCKUS SmartZone menerapkan pemisahan tersebut melalui \textit{control/management plane} dan \textit{data plane}, dengan trafik pengguna dapat diteruskan melalui \textit{local breakout} atau \textit{tunneling} menuju \textit{data plane}.
